...
const urbanStations: {
  ...
  { position: [35.4298,   7.1480  ], name: "محطة الحافلات أولاد رشاش", nameEn: "Ouled Rechache Bus Station", lines: ["line-06"],                              isMain: true  },
  { position: [35.3500,   7.1420  ], name: "تازوقاغت وسط",             nameEn: "Tazoughaght Centre",         lines: ["line-06"],                              isMain: true  },
...
const urbanRoutePolylines: {
  ...
  { id: "line-06", lineNumber: "06", color: "#E74C3C", arabicName: "خط 06 — المحمل",
    waypoints: [[35.4298,7.1480],[35.4050,7.1465],[35.3800,7.1445],[35.3600,7.1430],[35.3500,7.1420]] },

...
const urbanStations: {
  ...
  { position: [35.4308,   7.1486  ], name: "نقطة انطلاق دار الثقافة", nameEn: "Dar Thaqafa Departure Point", lines: ["line-06"],                              isMain: true  },
  { position: [35.3697,   7.2154  ], name: "نقطة وصول تازوقاغت",      nameEn: "Tazoughaght Arrival Point",  lines: ["line-06"],                              isMain: true  },
...
const urbanRoutePolylines: {
  ...
  { id: "line-06", lineNumber: "06", color: "#E74C3C", arabicName: "خط 06 — المحمل",
    waypoints: [[35.4308,7.1486],[35.4272,7.1528],[35.4150,7.1650],[35.4000,7.1800],[35.3850,7.1970],[35.3697,7.2154]] },

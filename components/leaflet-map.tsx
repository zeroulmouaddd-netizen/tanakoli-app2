...
const urbanStations: { position: [number, number]; name: string; nameEn: string; arabicLabel: string; lines: string[]; isMain: boolean; category: "urban" }[] = [
  ...
  { position: [35.3711,  7.2190  ], name: "نقطة وصول المحمل وسط", nameEn: "El Mahmal Centre Arrival", arabicLabel: "نقطة وصول المحمل وسط", lines: ["line-06"], isMain: true, category: "urban" },
  { position: [35.4298,  7.1480  ], name: "نقطة انطلاق دار الثقافة", nameEn: "Dar Thaqafa Departure Point", arabicLabel: "نقطة انطلاق دار الثقافة", lines: ["line-06"], isMain: true, category: "urban" },
...
const urbanRoutePolylines: {
  ...
  },
  {
    ...
    terminalTo: "نقطة وصول المحمل وسط",
    stops: [
      { name: "نقطة انطلاق دار الثقافة", nameEn: "Dar Thaqafa Departure Point", coords: [35.4298, 7.1480], isTerminal: true  },
      { name: "نقطة وصول المحمل وسط",    nameEn: "El Mahmal Centre Arrival",    coords: [35.3711, 7.2190], isTerminal: true  },
    ],
    waypoints: [
      [35.4298, 7.1480],
      [35.4240, 7.1550],

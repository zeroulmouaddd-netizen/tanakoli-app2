...
const urbanStations: { position: [number, number]; name: string; nameEn: string; arabicLabel: string; lines: string[]; isMain: boolean; category: "urban" }[] = [
  ...
  { position: [35.4296,  7.1499  ], name: "نقطة انطلاق دار الثقافة", nameEn: "Dar Thaqafa Departure Point", arabicLabel: "نقطة انطلاق دار الثقافة", lines: ["line-06"], isMain: true, category: "urban" },
...
const urbanRoutePolylines: {
  ...
  },
  {
    ...
    stops: [
      { name: "نقطة انطلاق دار الثقافة", nameEn: "Dar Thaqafa Departure Point", coords: [35.4296000, 7.1498576], isTerminal: true },

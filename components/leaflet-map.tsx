...
const urbanStations: { position: [number, number]; name: string; nameEn: string; arabicLabel: string; lines: string[]; isMain: boolean; category: "urban" }[] = [
  ...
  { position: [35.4298,  7.1480  ], name: "محطة الحافلات أولاد رشاش", nameEn: "Ouled Rechache Bus Station", arabicLabel: "محطة الحافلات أولاد رشاش", lines: ["line-06"], isMain: true, category: "urban" },
  { position: [35.3500,  7.1420  ], name: "تازوقاغت وسط",             nameEn: "Tazoughaght Centre",         arabicLabel: "تازوقاغت وسط",             lines: ["line-06"], isMain: true, category: "urban" },
...
const urbanRoutePolylines: {
  ...
  },
  {
    ...
    color: "#E74C3C",
    category: "urban",
    terminalFrom: "محطة الحافلات أولاد رشاش",
    terminalTo: "تازوقاغت وسط",
    stops: [
      { name: "محطة الحافلات أولاد رشاش", nameEn: "Ouled Rechache Bus Station", coords: [35.4298, 7.1480], isTerminal: true },
      { name: "تازوقاغت وسط",             nameEn: "Tazoughaght Centre",         coords: [35.3500, 7.1420], isTerminal: true },
    ],
    waypoints: [
      [35.4298, 7.1480],
      [35.4050, 7.1465],

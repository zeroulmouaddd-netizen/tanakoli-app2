...
const urbanRoutes: BusRoute[] = [
  ...
  },
  {
    ...
    category: "urban",
    stops: [
      { id: "05-s1", name: "نقطة انطلاق الحامة", nameEn: "Hama Departure Point", coords: [35.42717, 7.144128], order: 1 },
      { id: "05-s2", name: "دوار الخروج",         nameEn: "Exit Roundabout",      coords: [35.43193, 7.13841 ], order: 2 },
      { id: "05-s3", name: "طريق RN88",            nameEn: "RN88 Road",            coords: [35.44634, 7.12330 ], order: 3 },
      { id: "05-s4", name: "منطقة وسط",            nameEn: "Mid-route",            coords: [35.45391, 7.10773 ], order: 4 },
      { id: "05-s5", name: "الحامة",               nameEn: "Al-Hama (centre)",     coords: [35.463697, 7.083935], order: 5 },
    ],
    sub_stations: [
      { id: "sub-05-1", name: "نقطة انطلاق الحامة", nameEn: "Hama Departure Point", coords: [35.42717, 7.144128], order: 1 },
      { id: "sub-05-2", name: "دوار الخروج",         nameEn: "Exit Roundabout",      coords: [35.43193, 7.13841 ], order: 2 },
      { id: "sub-05-3", name: "طريق RN88",            nameEn: "RN88 Road",            coords: [35.44634, 7.12330 ], order: 3 },
      { id: "sub-05-4", name: "منطقة وسط",            nameEn: "Mid-route",            coords: [35.45391, 7.10773 ], order: 4 },
      { id: "sub-05-5", name: "الحامة",               nameEn: "Al-Hama (centre)",     coords: [35.463697, 7.083935], order: 5 },
    ],
  },
  {
    id: "route-06",
    ...
    category: "urban",
    stops: [
      { id: "06-s1", name: "نقطة انطلاق دار الثقافة", nameEn: "Dar Thaqafa Departure Point", coords: [35.4296, 7.1499], order: 1 },
      { id: "06-s2", name: "نقطة وصول تازوقاغت",      nameEn: "Tazoughaght Arrival Point",   coords: [35.3697, 7.2154], order: 2 },
    ],
    sub_stations: [
      { id: "sub-06-1", name: "نقطة انطلاق دار الثقافة", nameEn: "Dar Thaqafa Departure Point", coords: [35.4296, 7.1499], order: 1 },
  ...
  },
  {
    ...
    category: "urban",
    stops: [
      { id: "11-s1", name: "منطقة الانطلاق — الشابور", nameEn: "Departure — Shabour",    coords: [35.42722022, 7.14421289], order: 1 },
      { id: "11-s2", name: "المحطة 1",                  nameEn: "Stop 1",                 coords: [35.43126942, 7.1378072 ], order: 2 },
      { id: "11-s3", name: "الكوشة",                    nameEn: "Cosha",                  coords: [35.42695195, 7.13272788], order: 3 },
      { id: "11-s4", name: "السوق",                     nameEn: "Souk",                   coords: [35.42449995, 7.12998427], order: 4 },
      { id: "11-s5", name: "باطيمات",                   nameEn: "Batimat",                coords: [35.42258364, 7.12852322], order: 5 },
      { id: "11-s6", name: "باطيمات الشابور",           nameEn: "Batimat Shabour",        coords: [35.41986393, 7.12457735], order: 6 },
      { id: "11-s7", name: "مسجد الفرقان",              nameEn: "Mosque Al-Forqan (End)", coords: [35.39635079, 7.10094865], order: 7 },
    ],
    sub_stations: [
      { id: "sub-11-1", name: "منطقة الانطلاق — الشابور", nameEn: "Departure — Shabour",    coords: [35.42722022, 7.14421289], order: 1 },
      { id: "sub-11-2", name: "المحطة 1",                  nameEn: "Stop 1",                 coords: [35.43126942, 7.1378072 ], order: 2 },
      { id: "sub-11-3", name: "الكوشة",                    nameEn: "Cosha",                  coords: [35.42695195, 7.13272788], order: 3 },
      { id: "sub-11-4", name: "السوق",                     nameEn: "Souk",                   coords: [35.42449995, 7.12998427], order: 4 },
      { id: "sub-11-5", name: "باطيمات",                   nameEn: "Batimat",                coords: [35.42258364, 7.12852322], order: 5 },
      { id: "sub-11-6", name: "باطيمات الشابور",           nameEn: "Batimat Shabour",        coords: [35.41986393, 7.12457735], order: 6 },
      { id: "sub-11-7", name: "مسجد الفرقان",              nameEn: "Mosque Al-Forqan (End)", coords: [35.39635079, 7.10094865], order: 7 },
    ],
  },
]
...
const fallbackStations: Station[] = [
  ...
  { id: "station-culture",    name: "نقطة انطلاق دار الثقافة", nameEn: "Dar Thaqafa Departure Point", address: "شارع عباس لغرور - محطة الحافلات أولاد رشاش - خنشلة", coords: [35.4296,   7.1499  ], lines: ["06"], facilities: ["shelter","bench"],           isMainStation: true  },
